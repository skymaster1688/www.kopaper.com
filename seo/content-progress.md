...
- [ ] best-origami-paper | keyword: "best origami paper for beginners" | url: /learn/best-origami-paper/ | file: src/content/learn/best-origami-paper.md | emoji: 📄 | order: 1 | 要点: 选购指南，对比 kami/tant/washi/foil 的重量·尺寸·价格·适用场景，给新手明确推荐；内链到 what-paper-for-origami、types-of-origami-paper，外链 2 个 origami 教程(/origami/crane/、/origami/box/)
- [ ] what-paper-for-origami | keyword: "what paper to use for origami" | url: /learn/what-paper-for-origami/ | file: src/content/learn/what-paper-for-origami.md | emoji: 📄 | order: 2 | 要点: 科普向，按项目类型(简单/复杂/湿折/儿童)推荐纸张；内链到 origami-paper-size、best-origami-paper，外链 /origami/flower/、/origami/frog/
